...
<div class="configuracao-dashboard-panel">
    <div class="row">
        ...
        <div class="lista-titulo"><i class="fas fa-dice-d6" style="margin-left:10px"></i><span style="margin-left:0px"> Ambientes Disponiveis</span></div>
            ...
            <table class="table table-hover table-striped">
                ...
                foreach ($dados as $key => $lista) { ?>
                    <tr>
                        ...
                        <td style="width:10%;border:none"><a href="ambientes/delete/<?php echo $dados[$key]['id_ambiente'] ?> "><i class="fas fa-trash"></i></a></td>
