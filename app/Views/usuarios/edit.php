      ...
      <div class="container dashboard">
        ...
        <div class="form-group col-sm-11 " style="margin-left: 0px;">
          ...
          <div class="form-group col-sm-11 " style="margin-left: 0px;">
            ...
            <input type="text" class="form-control" id="senha" name="senha"  value="<?php echo $this->senha ?>">
          </div>
          <div class="form-group col-sm-11 " style="margin-left: 0px;">
            <label for="confirma_senha">Confirma senha:</label>
            <input type="text" class="form-control" id="nome" name="confirma_senha"value="<?php echo $this->senha ?>">
          </div>
          <div class="form-group col-sm-11 " style="margin-left: 0px;">
