<body>
  <div class="container dashboard-panel">
    <div class="row">
      ...
      <div class="user-info-bar"><i class="fas fa-user" style="margin-left:10px"></i><span style="margin-left:10px"> Usuario: <?php if (isset($_SESSION['usuario'])) echo $_SESSION['usuario']  ?></span></div>
      <div class="container">
        <div class="dashboard">
